...
char heap[32*1024]; //From 2K to 32K by YP
#endif

volatile int file_system_mode = 1;
int main(int argc, char **argv) {
	...
	state.reset_mode = file_system_mode; //YP reset the file system:BOARDCTRL_RESET_MODE_FACTORY_FILESYSTEM

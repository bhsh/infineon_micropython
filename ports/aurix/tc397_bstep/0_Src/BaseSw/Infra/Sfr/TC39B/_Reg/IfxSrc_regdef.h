...
/******************************************************************************/
/******************************************************************************/
/** \addtogroup IfxSfr_Src_VADC_CG_struct
 * \{  */
/******************************************************************************/
/** \name Object L2
 * \{  */
/** \brief CG object */
typedef volatile struct _Ifx_SRC_VADC_CG
{
       Ifx_SRC_SRCR                        SR0;                    /**< \brief 0, EVADC Common Group ${x} Service Request ${y}*/
       Ifx_SRC_SRCR                        SR1;                    /**< \brief 4, EVADC Common Group ${x} Service Request ${y}*/
       Ifx_SRC_SRCR                        SR2;                    /**< \brief 8, EVADC Common Group ${x} Service Request ${y}*/
       Ifx_SRC_SRCR                        SR3;                    /**< \brief C, EVADC Common Group ${x} Service Request ${y}*/
} Ifx_SRC_VADC_CG;
/** \}  */
/******************************************************************************/
/** \}  */
